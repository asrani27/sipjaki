  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-warning">
        ...
        <form class="form-horizontal" action="/superadmin/berita/edit/{{$data->id}}" method="post"
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <img src="https://minio.banjarmasinkota.go.id/asrani/sipjaki/{{$data->gambar}}" width="100px">
                Maks 2MB
              </div>
            </div>
            <div class="form-group">
