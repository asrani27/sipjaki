        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="https://minio.banjarmasinkota.go.id/asrani/sipjaki/{{$slide1}}" alt="First slide"
                        style="max-height:400px; min-height:400px; width:900px">
                ...
                <div class="item">
                    <img src="https://minio.banjarmasinkota.go.id/asrani/sipjaki/{{$slide2}}" alt="Second slide"
                        style="max-height:400px; min-height:400px; width:900px">
                ...
                <div class="item">
                    <img src="https://minio.banjarmasinkota.go.id/asrani/sipjaki/{{$slide3}}" alt="Third slide"
                        style="max-height:400px; min-height:400px; width:900px">
            ...
            <div class="box box-widget widget-user">
                ...
                <div class="box-header with-border">
                    <div class="user-block">
                        ...
                        <span class="username"><a href="#" style="color: rgb(125, 123, 123)">Di Posting Oleh
                                Admin</a></span>
                        <span class="description">{{\Carbon\Carbon::parse($item->created_at)->format('d M Y
                            H:i:s')}}</span>
                    </div>
